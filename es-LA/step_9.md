...
Si estás siguiendo el camino [Introducción a Python](https://projects.raspberrypi.org/es-LA/raspberrypi/python-intro), puedes pasar al proyecto [Hacer una cara](https://projects.raspberrypi.org/es-LA/projects/make-a-face). En este proyecto, dibujarás una cara o una máscara usando formas geométricas.
