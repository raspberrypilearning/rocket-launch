...
def draw_background():   
  ...
  no_fill() #Вимкнення будь-якої заливки  
  stroke(255) #Встановлення білого обведення   
  stroke_weight(2)   
...
---
  ...
  if fuel < burn and rocket_y > orbit_y: #Палива більше немає та орбіти не досягнуто   
    tint(255, 0, 0) #Провал
...
no_tint() #Тобто на наступному кадрі планета не буде червоною!
...
if fuel < burn and rocket_y > orbit_y:   
  ...
  tint(255, 200, 0) #Занадто багато пального   
    
image(rocket, width/2, rocket_y, 64, 64)    
no_tint() #Щоб на наступному кадрі планета не була підфарбована!
